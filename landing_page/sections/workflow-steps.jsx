...
const steps = [
    {
        ...
        description: "Start by creating a new game room or join an existing one. Share the room code with your friends to play together on the local network.",
        link: "#!",
    ...
    },
    {
        ...
        description: "Select from a variety of classic board games. Each game comes with customizable rules and settings to match your group's preferences.",
        link: "#!",
    ...
    },
    {
        id: 3,
        title: "Play & Have Fun",
        description: "Enjoy real-time gameplay with smooth synchronization. The game state is managed client-side for a responsive and lag-free experience.",
        link: "#!",
    ...
    return (
        <section className="mt-32 relative" id="how-it-works">
            <SectionTitle
                ...
                description="From setup to gameplay in seconds - no complicated configuration required."
            />
