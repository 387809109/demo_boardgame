        ...
        <>
            ...
            >
                ...
                <div className='hidden items-center space-x-10 md:flex'>
                    ...
                    <Link href='https://github.com/387809109/demo_boardgame' target="_blank" className='btn glass'>
                        GitHub
                    </Link>
                </div>
            ...
            <div className={`fixed inset-0 z-50 flex flex-col items-center justify-center gap-6 bg-black/20 text-lg font-medium backdrop-blur-2xl transition duration-300 md:hidden ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <Link href='https://github.com/387809109/demo_boardgame' target="_blank" className='btn glass' onClick={() => setIsOpen(false)}>
                    GitHub
                </Link>
