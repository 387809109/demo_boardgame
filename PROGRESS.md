...
| werewolf/integration.test.js | 4 | ✅ |
| **总计** | **408** | ✅ |
...
- `frontend/src/games/werewolf/integration.test.js` - 狼人杀集成测试 (4 tests)
...
5. **狼人杀进阶角色** - P2/P3 角色开发 (T-F-R201-T-F-R305)
...
- ✅ 狼人杀 P1 角色实现与集成测试
  - 新增角色：守卫 / 丘比特 / 警长 / 私刑者 / 白痴 / 魔笛手 / 队长
  - 增加夜晚行动、胜利条件与 UI 行动面板支持
  - 新增 `frontend/src/games/werewolf/integration.test.js` 集成测试

- ✅ 狼人杀强化：夜晚自动推进、角色规则与 UI 改进
  - 夜晚行动齐备后自动进入白天
