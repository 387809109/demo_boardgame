...
#### 狼人杀游戏 🔶 开发中 (P0 完成 + P1 部分完成，综合测试未完成)
...
| T-F073 | 狼人杀 UI ui.js | ✅ |
| T-F074 | 狼人杀角色单元测试 (154 tests，含 P1 部分) | ✅ |
| T-F076 | P0 基础角色 (6 角色) | ✅ |
| T-F075 | 集成测试 (手动/端到端) | ⬜ |
| T-F077 | P1 进阶角色 (6 角色，已完成 4/6) | 🔶 |

> **注意**: 已完成 P1 角色 `bodyguard`、`cupid`、`idiot`、`jester`，狼人杀自动化测试已扩展至 154 项；综合测试（手动端到端、多人联机流程）尚未完成。
...
- `src/games/werewolf/*.test.js` - 狼人杀测试 (154 tests)
